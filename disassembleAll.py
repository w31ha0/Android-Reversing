...
os.system('java -jar apktool_2.2.3.jar d '+apk)
...
os.system('java -jar cfr_0_122.jar dex2jar-2.0/temp1.jar --outputdir '+app_name+'/java')
os.system('java -jar cfr_0_122.jar dex2jar-2.0/temp2.jar --outputdir '+app_name+'/java')
